...
echo 1200 > ${hwmondir}/pwm1_auto_point2_pwm
echo 1500 > ${hwmondir}/pwm1_auto_point3_pwm
echo 2000 > ${hwmondir}/pwm1_auto_point4_pwm
echo 2400 > ${hwmondir}/pwm1_auto_point5_pwm
echo 2600 > ${hwmondir}/pwm1_auto_point6_pwm
echo 3000 > ${hwmondir}/pwm1_auto_point7_pwm
echo 3500 > ${hwmondir}/pwm1_auto_point8_pwm
echo 4000 > ${hwmondir}/pwm1_auto_point9_pwm
echo 4500 > ${hwmondir}/pwm1_auto_point10_pwm

# 2. Fan: Set the fan speed (rmp) of the second fan for the first 10 points; first must be 0)
# If you want more, just continue 
echo 0    > ${hwmondir}/pwm1_auto_point1_pwm
echo 1350 > ${hwmondir}/pwm1_auto_point2_pwm
echo 1800 > ${hwmondir}/pwm1_auto_point3_pwm
echo 2400 > ${hwmondir}/pwm1_auto_point4_pwm
echo 2600 > ${hwmondir}/pwm1_auto_point5_pwm
echo 2800 > ${hwmondir}/pwm1_auto_point6_pwm
echo 3000 > ${hwmondir}/pwm1_auto_point7_pwm
echo 3500 > ${hwmondir}/pwm1_auto_point8_pwm
echo 4000 > ${hwmondir}/pwm1_auto_point9_pwm
echo 4500 > ${hwmondir}/pwm1_auto_point10_pwm
