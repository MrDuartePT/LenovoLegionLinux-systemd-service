...
echo 0 > ${hwmondir}/pwm1_auto_point3_pwm
echo 0 > ${hwmondir}/pwm1_auto_point4_pwm
echo 500 > ${hwmondir}/pwm1_auto_point5_pwm
echo 1000 > ${hwmondir}/pwm1_auto_point6_pwm
echo 1200 > ${hwmondir}/pwm1_auto_point7_pwm
echo 2500 > ${hwmondir}/pwm1_auto_point8_pwm
...
echo 500 > ${hwmondir}/pwm2_auto_point5_pwm
echo 1200 > ${hwmondir}/pwm2_auto_point6_pwm
echo 1800 > ${hwmondir}/pwm2_auto_point7_pwm
...
echo 70 > ${hwmondir}/pwm1_auto_point7_temp_hyst
echo 80 > ${hwmondir}/pwm1_auto_point8_temp_hyst
...
echo 127 > ${hwmondir}/pwm1_auto_point8_temp
...
echo 55 > ${hwmondir}/pwm2_auto_point6_temp_hyst
echo 58 > ${hwmondir}/pwm2_auto_point7_temp_hyst
echo 60 > ${hwmondir}/pwm2_auto_point8_temp_hyst
...
echo 55 > ${hwmondir}/pwm2_auto_point5_temp
echo 58 > ${hwmondir}/pwm2_auto_point6_temp
echo 60 > ${hwmondir}/pwm2_auto_point7_temp
echo 127 > ${hwmondir}/pwm2_auto_point8_temp
...
echo 60 > ${hwmondir}/pwm3_auto_point8_temp_hyst
...
echo 60 > ${hwmondir}/pwm3_auto_point7_temp
echo 127 > ${hwmondir}/pwm3_auto_point8_temp
