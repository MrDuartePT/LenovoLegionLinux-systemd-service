...
echo 800 > ${hwmondir}/pwm1_auto_point5_pwm
echo 1000 > ${hwmondir}/pwm1_auto_point6_pwm
echo 2000 > ${hwmondir}/pwm1_auto_point7_pwm
...
echo 800 > ${hwmondir}/pwm2_auto_point4_pwm
echo 1000 > ${hwmondir}/pwm2_auto_point5_pwm
