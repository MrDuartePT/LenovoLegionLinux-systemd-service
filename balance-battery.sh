...
echo 500 > ${hwmondir}/pwm1_auto_point4_pwm
...
echo 500 > ${hwmondir}/pwm2_auto_point4_pwm
echo 1200 > ${hwmondir}/pwm2_auto_point5_pwm
echo 1600 > ${hwmondir}/pwm2_auto_point6_pwm
echo 2200 > ${hwmondir}/pwm2_auto_point7_pwm
echo 2500 > ${hwmondir}/pwm2_auto_point8_pwm
...
echo 3 > ${hwmondir}/pwm1_auto_point1_accel
echo 3 > ${hwmondir}/pwm1_auto_point2_accel
echo 3 > ${hwmondir}/pwm1_auto_point3_accel
echo 3 > ${hwmondir}/pwm1_auto_point4_accel
echo 3 > ${hwmondir}/pwm1_auto_point5_accel
echo 3 > ${hwmondir}/pwm1_auto_point6_accel
echo 2 > ${hwmondir}/pwm1_auto_point7_accel
echo 2 > ${hwmondir}/pwm1_auto_point8_accel
echo 1 > ${hwmondir}/pwm1_auto_point9_accel
echo 1 > ${hwmondir}/pwm1_auto_point10_accel

# Decleration time (larger = slower acceleartion) for each level for the first 6 points; 
echo 3 > ${hwmondir}/pwm1_auto_point1_decel
echo 3 > ${hwmondir}/pwm1_auto_point2_decel
...
echo 2 > ${hwmondir}/pwm1_auto_point10_decel
